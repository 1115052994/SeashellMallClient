...
public class SPs {
    ...
    public static boolean isOpenPushStatus(){
        SharedPreferences openShared = MApplication.getAppContext().getSharedPreferences(FILE_NAME,Context.MODE_PRIVATE);
        return openShared.getBoolean(IS_OPEN_PUSH,true);
    }
    ...
    public static void setPushStatus(boolean status){
        SharedPreferences openShared = MApplication.getAppContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = openShared.edit();
        editor.putBoolean(IS_OPEN_PUSH,status);
        editor.apply();
        editor.commit();
    }
}
