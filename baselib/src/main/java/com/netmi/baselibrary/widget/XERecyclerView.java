...
public class XERecyclerView extends RecyclerView {
    ...
    private XERecyclerView.WrapAdapter mWrapAdapter;
    ...
    private final RecyclerView.AdapterDataObserver mDataObserver = new XERecyclerView.DataObserver();
    ...
    public XERecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XERecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    //判断是否是XERecyclerView保留的itemViewType
    ...
    public void setFootView(@NonNull final View view, @NonNull CustomFooterViewCallBack footerViewCallBack) {
        if (view == null || footerViewCallBack == null || mFootView == view) {
            return;
        }
        mFootView = view;
    ...
    public void setAdapter(Adapter adapter) {
        mWrapAdapter = new XERecyclerView.WrapAdapter(adapter);
                ...
                gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                    ...
                    public int getSpanSize(int position) {
                        return (mWrapAdapter.isHeader(position) || mWrapAdapter.isFooter(position) || mWrapAdapter.isRefreshHeader(position))
                                ? gridManager.getSpanCount() : (sizeLookup != null ? sizeLookup.getSpanSize(position - getHeaders_includingRefreshCount()) : 1);
                    }
                });
            }
        }
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    XERecyclerView.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    XERecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
    ...
    private class WrapAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_REFRESH_HEADER) {
                return new XERecyclerView.WrapAdapter.SimpleViewHolder(mRefreshHeader);
            } else if (isHeaderType(viewType)) {
                return new XERecyclerView.WrapAdapter.SimpleViewHolder(getHeaderViewByType(viewType));
            } else if (viewType == TYPE_FOOTER) {
                return new XERecyclerView.WrapAdapter.SimpleViewHolder(mFootView);
            }
        ...
        public void onAttachedToRecyclerView(RecyclerView recyclerView) {
            ...
            if (manager instanceof GridLayoutManager) {
                ...
                gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                    @Override
                    public int getSpanSize(int position) {
                        return (isHeader(position) || isFooter(position) || isRefreshHeader(position) || (adapter instanceof BaseRViewAdapter && ((BaseRViewAdapter) adapter).isShowEmpty()))
    ...
    private XERecyclerView.ScrollAlphaChangeListener scrollAlphaChangeListener;

    public void setScrollAlphaChangeListener(
            XERecyclerView.ScrollAlphaChangeListener scrollAlphaChangeListener
    ) {
