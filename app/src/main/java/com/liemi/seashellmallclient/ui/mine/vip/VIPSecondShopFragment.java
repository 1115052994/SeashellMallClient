...
public class VIPSecondShopFragment extends BaseXRecyclerFragment<BaselibFragmentXrecyclerviewBinding, MyVIPMemberEntity> {

    private String uid;

    public static VIPSecondShopFragment newInstance(String uid) {
        VIPSecondShopFragment f = new VIPSecondShopFragment();
    ...
    protected void doListData() {
        ...
        observable = RetrofitApiFactory.createApi(VIPApi.class)
                .getMyVIPFollowersSecond(PageUtil.toPage(startPage), Constant.PAGE_ROWS,uid,"2");
        observable.compose(RxSchedulers.compose())
                ...
                .subscribe(new FastObserver<BaseData<VIPMemberPageEntity<MyVIPMemberEntity>>>(this) {
                    ...
                    public void onSuccess(BaseData<VIPMemberPageEntity<MyVIPMemberEntity>> data) {
                        EventBus.getDefault().post(new VipFollowerSecondNumEvent(1, Strings.toInt(data.getData().getTotal_count())));
