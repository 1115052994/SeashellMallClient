...
public class VIPFollowerSecondFragment extends BaseXRecyclerFragment<BaselibFragmentXrecyclerviewBinding, MyVIPMemberEntity> {
    ...
    public static VIPFollowerSecondFragment newInstance(String uid) {
        VIPFollowerSecondFragment f = new VIPFollowerSecondFragment();
    ...
    protected void doListData() {
        ...
        observable = RetrofitApiFactory.createApi(VIPApi.class)
                    .getMyVIPFollowersSecond(PageUtil.toPage(startPage), Constant.PAGE_ROWS,uid,"1");
        observable.compose(RxSchedulers.compose())
                ...
                .subscribe(new FastObserver<BaseData<VIPMemberPageEntity<MyVIPMemberEntity>>>(this) {
                    ...
                    public void onSuccess(BaseData<VIPMemberPageEntity<MyVIPMemberEntity>> data) {
                        EventBus.getDefault().post(new VipFollowerSecondNumEvent(0, Strings.toInt(data.getData().getTotal_count())));
