...
import com.liemi.seashellmallclient.databinding.SharemallDialogAddressBinding;
...
public class AddressDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(getContext()),R.layout.sharemall_dialog_address,null,false);
