...
public class PayDialog extends Dialog implements View.OnClickListener {
    ...
    void initDilaog() {
        ...
        lines = new ArrayList<>();
        lines.add(findViewById(R.id.pwd_line1));
        lines.add(findViewById(R.id.pwd_line2));
        lines.add(findViewById(R.id.pwd_line3));
        lines.add(findViewById(R.id.pwd_line4));
        lines.add(findViewById(R.id.pwd_line5));

        getTvForgetPwd().setOnClickListener((View view) -> {
            dismiss();
    ...
    private void refreshPwdUI() {
        ...
        getTvForgetPwd().setTextColor(errorColor);
    }
    ...
    public TextView getTvForgetPwd() {
        return findViewById(R.id.tv_forget_pwd);
    }
